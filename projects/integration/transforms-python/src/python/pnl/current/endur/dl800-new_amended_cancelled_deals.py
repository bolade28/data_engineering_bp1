...
from python.bp_flush_control import DL800_FLUSH, DL800_FLUSH_START_DATE

FLUSH = DL800_FLUSH
FLUSH_START_DATE = DL800_FLUSH_START_DATE


@transform_df(
    Output("/BP/IST-IG-DD/data/technical/pnl/current/endur/dl800_new_amended_cancelled_deals"),
    df=Input("/BP/IST-IG-DD/data/technical/pnl/typed/endur/dl800_new_amended_cancelled_deals"),
)
def my_compute_function(ctx, df):
    ...
    Args:
        ...
        params2 (dataframe): typed dl800

    Returns:
        dataframe: current dl800
    """
