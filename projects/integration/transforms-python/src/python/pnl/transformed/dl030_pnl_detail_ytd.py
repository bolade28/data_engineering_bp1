...
@transform_df(
    Output("/BP/IST-IG-DD/data/technical/pnl/transformed/dl030_pnl_detail_ytd"),
    df=Input("/BP/IST-IG-DD/data/technical/pnl/current/endur/dl030-pnl_detail_ytd"),
)
def dtd_calc(df):
    ...
    Args:
        params1 (dataframe): current dl030

    Returns:
        dataframe: transformed dl030
    """
