...
@incremental()
@transform_df(
    Output("/BP/IST-IG-DD/data/technical/exposure/typed/endur/dl120-market_risk_stage_result"),
    df=Input("/BP/IST-IG-SS-Systems/data/raw/endur/dl120-market_risk_stage_result/dl120-market_risk_stage_result"),
)
def my_compute_function(df):
    ...
    Args:
        params1 (dataframe): raw dl120

    Returns:
        dataframe: typed dl120
    '''
    df = df.select(
