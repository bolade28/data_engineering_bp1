...
@transform_df(
    Output("/BP/IST-IG-DD/data/published/all/pnl/latest/dl035_pnl_by_portfolio_and_instrument"),
...
def my_compute_function(ctx, df):
    ...
    Version : H1
    This function:
        Gets the latest run from each valuation from dl035 history and appends it onto dl035 latest

    Args:
        params1 (sparkContext): ctx
        params2 (dataframe): history dl035
        params3 (dataframe): latest dl035

    Returns:
        dataframe: latest dl035
    """
